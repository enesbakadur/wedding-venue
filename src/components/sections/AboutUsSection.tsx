        ...
        <div className="w-full md:w-1/2 flex flex-col gap-3 md:gap-6">
          <div>
            ...
            <p className={`${showMore ? "" : "max-md:line-clamp-3"}`}>
              Lorem ipsum dolor sit amet consectetur. Eros leo venenatis nisi
              laoreet elit mus leo amet euismod. Vel tincidunt hac tellus in
              quis amet libero sagittis nascetur. Nunc elit cursus viverra arcu
              nulla in libero ipsum suscipit. Vulputate sed varius pharetra sed
              eget. Duis amet mi at augue elit faucibus volutpat. Elementum
              volutpat aliquam iaculis risus at. Porta facilisis laoreet nunc
              gravida. Vitae et nullam hac nullam odio id. Scelerisque orci
              pellentesque sit elementum pulvinar facilisi. Sem proin nisl
              varius sit eleifend egestas augue. Hendrerit non odio orci
              ultricies pellentesque facilisi. Eget sit nunc mauris ornare
              consectetur quis suspendisse. <br /> <br /> Lacus habitasse vel
              semper sagittis nisi integer gravida. Massa quis suspendisse
              tortor tortor pellentesque auctor ac ipsum amet. Varius.
            </p>
            <button
              className="underline underline-offset-2 text-black inline-block md:hidden"
          ...
          <div className="flex gap-2 items-center">
            <a
              ...
              className="hover:text-[#D7C2AE] hover:rotate-12 transform transition-transform duration-300 ease-in-out"
            >
